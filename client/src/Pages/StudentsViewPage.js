  ...
  return (
    <>
      ...
      <Container fluid className="mt-3">
        <ButtonGroup className="mb-3 gap-2 d-flex justify-content-center w-25 mx-auto">
          <Button
          ...
          <Button
            variant="outline-primary"
            className={`${evaluatedFilter === "pending" ? "active" : ""} rounded-pill`}
            onClick={() => {
          ...
          <Button
            variant="outline-primary"
            className={`${evaluatedFilter === "evaluated" ? "active" : ""} rounded-pill`}
            onClick={() => {
        ...
        <Table striped bordered hover className="mx-2 text-center">
          <thead>
            <tr>
              <th>Name</th>
              <th>Email</th>
